...
- AI Resources
  ...
  - [AI Agent Roadmap](https://github.com/Yuan-ManX/ai-agent-roadmap), [LLM App Stack](https://github.com/a16z-infra/llm-app-stack), [🤖 Awesome ChatGPT](https://github.com/sindresorhus/awesome-chatgpt),  [Audio AI Agent](https://github.com/Yuan-ManX/audio-ai-agent), [ComfyUI Tools Roadmap](https://github.com/Yuan-ManX/ComfyUI-Tools-Roadmap), [AI Multimodal Timeline](https://github.com/Yuan-ManX/ai-multimodal-timeline), [AI Voice Agents](https://github.com/Yuan-ManX/ai-voice-agents), [Awesome State-Space Resources for ML](https://github.com/AvivBick/awesome-ssm-ml)
