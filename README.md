...
- AI Resources
  ...
  - Agent: [AI Agent Roadmap](https://github.com/Yuan-ManX/ai-agent-roadmap), [Audio AI Agent](https://github.com/Yuan-ManX/audio-ai-agent),
  - [LLM App Stack](https://github.com/a16z-infra/llm-app-stack), [🤖 Awesome ChatGPT](https://github.com/sindresorhus/awesome-chatgpt), [ComfyUI Tools Roadmap](https://github.com/Yuan-ManX/ComfyUI-Tools-Roadmap), [AI Multimodal Timeline](https://github.com/Yuan-ManX/ai-multimodal-timeline), [Awesome State-Space Resources for ML](https://github.com/AvivBick/awesome-ssm-ml)
